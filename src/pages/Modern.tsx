...
function Modern() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/novel_modern")
      .then((response) => {
          ...
          <div className="flex flex-col items-center">
            <div className="bg-white w-[800px] px-[70px] py-[50px]">
              <div className="w-full">
                ...
                <div className="p-5 border-2 border-dashed border-[#ed0983] rounded-[25px] flex flex-col items-center">
                  <p className="mb-6 text-[28px]">
                    List truyện hiện đại đã đọc
                  </p>
                  <img
                    className="w-[50px] h-[50px] mb-6"
                    src="https://nguyettolau.files.wordpress.com/2012/08/0052.gif?w=50"
                    alt=""
                  />
                  ...
                  <img
                    ...
                    src="https://media.giphy.com/media/9GIiu3vuDMtKWWWgMN/giphy.gif"
                    alt=""
                  />
                </div>
              </div>
