        ...
        <div className="flex flex-col xl:flex-row justify-center xl:gap-28 gap-[30px]">
          <div className="flex flex-col items-center">
            <div className="py-[50px] w-[792px] bg-white px-[70px] gap-[27px]">
              ...
              <div className="w-full p-5 border-[2px] rounded-[25px] border-dashed border-[#00ccff] flex flex-col items-center justify-center">
                <img
                  className="w-[300px] h-[111px] mb-6"
                  src="https://onhocuahoai.wordpress.com/wp-content/uploads/2018/07/cropped-img_49525.png?w=600"
                  alt=""
                />
                <span className="text-[28px] text-[#00ccff] mb-6">
                  Danh sách tổng hợp truyện Showbiz
                </span>
                <img
                  className="w-[616px] h-[37.39px] mb-[27px]"
                  src="https://nguyettolau.files.wordpress.com/2012/08/201059_196074443_nijwcjtz.gif?w=400"
                  alt=""
                />
                <em className="text-center text-lg mb-[27px]">
                  <strong>*Lưu ý:</strong> Truyện có nói về showbiz hoặc nghề
                  nghiệp của nam-nữ chính có liên quan đến showbiz
                </em>
                    ...
                    >
                      <div className="flex items-center justify-center w-full gap-1">
                        <img
                          ...
                          src="https://hungole.files.wordpress.com/2014/10/icon-dong-hungole-blog-511.gif?w=13"
                          alt=""
                        />
                        <span className="text-[28px] text-[#00ccff]">
                          {letter}
                        </span>
                        <img
                          className="w-[15px] h-[15px]"
                ...
                <img
                  className="w-[616px] h-[37.39px] mb-6"
                  src="https://nguyettolau.files.wordpress.com/2012/08/201059_196074443_nijwcjtz.gif?w=400"
                  alt=""
                />
                <p className="mb-[27px] text-lg text-[#00ccff] font-bold">
